...
const tagClass: Record<string, string> = {
  ...
  "Most Popular": "badge-ember",
  "Best Seller": "badge-ember",
  Popular: "badge-ember",
};
        ...
        {fanFavorites.map((dish) => (
          ...
          >
            <div className="relative aspect-[4/3] w-full overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-surface-raised/90 via-transparent to-transparent" />
              <span className={`badge ${tagClass[dish.tag] ?? "badge-ember"} absolute left-4 top-4`}>
                {dish.tag}
              </span>
            </div>
            <div className="p-5">
              <div className="flex items-baseline justify-between gap-3">
                ...
                <span className="text-sm font-semibold text-gold">{dish.price}</span>
              </div>
